                        ...
                        <div class="row"> 
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea rows="3" required name="small_description" placeholder="Enter Small Description" class="form-controlmb-2"></textarea>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea rows="3" required name="meta_desription" placeholder="Enter Meta Description" class="form-control mb-2"></textarea>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <button  style="background-color: red; color: white; padding: 10px 20px; border: none; border-radius: 5px;" type="submit" class="btn btn primary" name="add_product_btn">Save</button>
                                </div>
                        </div>
                    </form>
                </div>
